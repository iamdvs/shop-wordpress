			...
			<div class="container">
					<div class="row">
                      ...
                      <p class="excert text-right">
                          ...
                          <ul class="blog-info-link mb-4 text-right d-block col-12">
                              <li class="w-100"><a href="#" class="ml-auto"><i class="far fa-user"></i> <?php the_breadcrumb(); ?></a></li>
                              <!-- <li><a href="#"><i class="far fa-comments"></i> 03 Comments</a></li> -->
                            </ul>
                            <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>

                            <h2 class="text-right mb-5 mr-3"><?php the_title(); ?></h2>
