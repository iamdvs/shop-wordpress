    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        ...
        <div class="col-md-6 col-lg-7 col-xl-6 offset-xl-1">
          <img class="img-fluid" src="<?php echo get_template_directory_uri();?>/img/home/hero-img.png" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <?php get_sidebar(); ?>
    ...
    <div class="container">
      <div class="section-intro text-center pb-90px">
        <img class="section-intro-img" src="<?php echo get_template_directory_uri();?>/img/home/section-icon.png" alt="">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="<?php echo get_template_directory_uri();?>/img/home/service1.png" alt="">
            </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="<?php echo get_template_directory_uri();?>/img/home/service2.png" alt="">
            </div>
            <div class="service-card-body">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="service-card text-center">
            <div class="service-card-img">
              <img class="img-fluid" src="<?php echo get_template_directory_uri();?>/img/home/service3.png" alt="">
            </div>
            <div class="service-card-body">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 col-md-6 mb-4 mb-md-0">
          <div class="about-img">
            <img class="img-fluid" src="<?php echo get_template_directory_uri();?>/img/home/about-img.png" alt="">
          </div>
        </div>
  ...
  <section class="section-margin pb-xl-5">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?php echo get_template_directory_uri();?>/img/home/tour1.png" alt="">
        ...
        <div class="col-md-6">
          ...
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?php echo get_template_directory_uri();?>/img/home/tour2.png" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-7">
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?php echo get_template_directory_uri();?>/img/home/tour3.png" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
        ...
        <div class="col-md-6 col-lg-5">
          <div class="tour-card">
            <img class="card-img rounded-0" src="<?php echo get_template_directory_uri();?>/img/home/tour4.png" alt="">
            <div class="tour-card-overlay">
              <div class="media">
                <div class="media-body">
                  <h4>Paris tour offer</h4>
          ...
          <div class="row">
            <div class="col-md-3 col-lg-2 align-self-center">
              <div class="testimonial__img">
                <img class="card-img rounded-0" src="<?php echo get_template_directory_uri();?>/img/testimonial/t-slider1.png" alt="">
              </div>
            </div>
          ...
          <div class="card-blog">
            ...
            <div class="card-blog-body">
              ...
              <ul class="card-blog-info">
                <li><a href="#"><span class="align-middle"><i class="ti-notepad"></i></span><?php the_time('F j, Y'); ?></a></li>
